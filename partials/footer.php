<!-- Footer -->
<footer class="footer footer-center bg-base-200 text-base-content/70 p-10 mt-20 border-t border-base-content/10">
  <aside>
  ...
  <nav>
    <div class="grid grid-flow-col gap-4">
      <a href="/terms.php" class="link link-hover">শর্তাবলী</a>
      <a href="/privacy.php" class="link link-hover">গোপনীয়তা নীতি</a>
      <a href="/contact.php" class="link link-hover">যোগাযোগ</a>
    </div>
  </nav>
</footer>
